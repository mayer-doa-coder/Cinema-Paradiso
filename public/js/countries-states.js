...
const countriesStates = {
    ...
    "Pakistan": ["Balochistan", "Khyber Pakhtunkhwa", "Punjab", "Sindh", "Gilgit-Baltistan", "Azad Kashmir"],
...
function getCountries() {
    return Object.keys(countriesStates).sort();
}

// Get states for a specific country
function getStates(country) {
    return countriesStates[country] || [];
}
